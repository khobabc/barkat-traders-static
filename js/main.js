...
jQuery(document).ready(function ($) {
  ...
  function sendEmail(from, message) {
    return emailjs.send(EMAILJS_SERVICE_ID, EMAILJS_TEMPLATE_ID, {
      ...
      title: "Barkat Traders - Contact Form",
      message: message,
    });
  }
  ...
  function validate() {
    ...
    if (html) {
      html =
        "Please provide values for following fields: <ul>" + html + "</ul>";
    }
    return html;
  }
  ...
  $("#send-mail").submit(function (event) {
    ...
    sendEmail(
      ...
      .then(function () {
        ...
        error.innerHTML = "Thank you! Your message has been sent successfully.";
        error.style.display = "block";
        $("#fname").val("");
        $("#email").val("");
        $("#message").val("");
